...
exports.text_contain_blocked_word = exports.STORY_DEFAULT_DURATION = exports.Permissions = exports.MemberRoles = exports.ALLOWED_MEDIA_TYPE = void 0;
const MemberRoles = exports.MemberRoles = Object.freeze({
  MEMBER: 'member',
  MODERATOR: 'moderator',
...
const text_contain_blocked_word = exports.text_contain_blocked_word = 'Text contain blocked word';
const ALLOWED_MEDIA_TYPE = exports.ALLOWED_MEDIA_TYPE = {
  image: ['jpg', 'jpeg', 'png'],
  video: ['mp4', 'mov']
};
const STORY_DEFAULT_DURATION = exports.STORY_DEFAULT_DURATION = 7000;
