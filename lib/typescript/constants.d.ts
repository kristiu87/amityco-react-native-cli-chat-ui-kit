export declare const MemberRoles: Readonly<{
    MEMBER: "member";
    MODERATOR: "moderator";
...
export declare const text_contain_blocked_word = "Text contain blocked word";
export declare const ALLOWED_MEDIA_TYPE: {
    image: string[];
    video: string[];
};
export declare const STORY_DEFAULT_DURATION = 7000;
